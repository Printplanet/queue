...
class Listener
{
    ...
    {
        $instance = new PhpExecutableFinder();
        return ProcessUtils::escapeArgument($instance->find(false));
    }
    ...
    {
        $me = $this;
        $process->run(function ($type, $line) use($me) {
            $me->handleWorkerOutput($type, $line);
        });
     ...
     * @param  string $line
     */
    public function handleWorkerOutput($type, $line)
    {
