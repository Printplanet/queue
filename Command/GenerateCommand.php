...
class GenerateCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $suggestedServiceId = Str::studlyCase($bundleName) . '.job.' . Str::studlyCase($className);
    ...
    {
        return str_replace(array('{{namespace}}', '{{className}}', '{{serviceId}}'), array($ns, $class, $serviceId), $template);
    }
