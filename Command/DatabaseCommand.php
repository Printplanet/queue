...
class DatabaseCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $types = array($entityName => 'Entity.txt', $entityName.'Repository' => 'Repository.txt');
        ...
        $serviceTemplate = $this->replacePlaceholders($this->getTemplate($flavor, 'Service.txt'), $namespace, $entityPath, $entityName, $tableName);
